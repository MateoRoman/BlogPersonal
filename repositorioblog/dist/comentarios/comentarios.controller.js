...
let ComentariosController = class ComentariosController {
    ...
    async updateComentario(id, updatedComentario) {
        try {
...
], ComentariosController.prototype, "getComentarios", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [comentario_dto_1.CreateComenarioDto]),
    __metadata("design:returntype", void 0)
], ComentariosController.prototype, "postComentarios", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ComentariosController.prototype, "deleteComentario", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, comentario_dto_1.CreateComenarioDto]),
    __metadata("design:returntype", Promise)
], ComentariosController.prototype, "updateComentario", null);
